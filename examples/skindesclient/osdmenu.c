...
#include <set>
#include <sstream>
#include <libvdrskinservice/skindesignerosdbase.h>
...
class cPlugOsdMenu : public skindesignerservice::cSkindesignerOsdMenu {
private:
...
cPlugOsdMenu::cPlugOsdMenu(void) : skindesignerservice::cSkindesignerOsdMenu("Skindesigner Client") {
...
void cPlugOsdMenu::SetMenu(int numItems, bool subfolder) {
    ...
    SetPluginMenu(menu, skindesignerservice::mtList);
    Clear();

    for (int i=0; i < numItems; i++) {
        skindesignerservice::cSkindesignerOsdItem *item = new skindesignerservice::cSkindesignerOsdItem();
...
void cPlugOsdMenu::SetDetailView(int element) {
    SetPluginMenu(meDetail, skindesignerservice::mtText);
    Clear();
    ClearTokens();
